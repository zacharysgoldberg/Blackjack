from app.api import betting
from app.api import hit_stand
from app.api import win_lose
from app.api import menu
from app.api.game_class import new_game
from app.api.leaderboard_class import update
